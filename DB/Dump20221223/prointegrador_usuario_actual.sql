...
--
-- Dumping data for table `usuario_actual`
--

LOCK TABLES `usuario_actual` WRITE;
/*!40000 ALTER TABLE `usuario_actual` DISABLE KEYS */;
/*!40000 ALTER TABLE `usuario_actual` ENABLE KEYS */;
UNLOCK TABLES;
